...
class LoRA_Sam(nn.Module):
    ...
    def save_lora_parameters(self, filename: str) -> None:
        ...
        merged_dict = {**a_tensors, **b_tensors, **prompt_encoder_tensors, **mask_decoder_tensors, **adapter_tensor}
    ...
    def forward(self, batched_input, multimask_output, image_size, point_coords, point_labels):
        return self.sam(batched_input, multimask_output, image_size, point_coords, point_labels)
